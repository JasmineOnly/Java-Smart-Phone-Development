...
public final class Automobile implements Serializable {
	...
	/*
	 * Methods to get Option based on different references, including (setName,
	 * optionName) (setName, optionIndex), (setIndex, optionName), (setIndex,
	 * optionIndex)
	 */
	...
	/*
	 * Methods to get Option price based on different references, including
	 * (setName, optionName) (setName, optionIndex), (setIndex, optionName),
	...
	/*
	 * Method to update option name based on different references, including
	 * (setName, optionName) (setName, optionIndex), (setIndex, optionName),
	 * (setIndex, optionIndex)
	 */
	...
	/*
	 * Method to update option price based on different references, including
	 * (setName, optionName) (setName, optionIndex), (setIndex, optionName),
	 * (setIndex, optionIndex)
	 */
