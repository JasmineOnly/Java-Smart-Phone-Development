...
public abstract class ProxyAutomobile {
	...
	// This function is used to edit optionset name, or option name or option
	// price
	public void edit(EditOptionEnum editOptionEnum, String[] editInfo) {
		Automobile auto = autoList.getAutomobile(editInfo[0]);// editInfo[0] is model name
		EditOption edit = new EditOption(auto, (++threadID), editInfo, editOptionEnum);
		edit.start();
	}
